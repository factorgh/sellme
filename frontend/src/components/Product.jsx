...
const Product = ({product}) => {
  return (
    <div  className='w-full md:w-96 h-96 flex flex-col bg-gray-100 b items-center  p-3 rounded'>
    <a className='no-underline' href={`/product/${product.slug}`}>
     ...
     <button className='bg-green-500 hover:bg-blue-600 hover:text-white w-30 p-3 mt-3 rounded-lg' >Add to cart</button>
  </div>
  )
}
